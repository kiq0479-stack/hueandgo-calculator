...
// 민주가 제공한 엑셀 기반 (2026-02-12, 2026-04-15 신상품 9건 추가)

export const PRODUCT_ADDON_MAPPING: Record<string, string[]> = {
  'P0000BRX': ['P0000BRP', 'P00000BD', 'P00000BN', 'P0000BOY'], // (파트너 전용) 5T 아크릴 카라비너 키링
  'P0000BRK': ['P00000LD', 'P00000BD', 'P00000BN', 'P00000DZ'], // (파트너 전용) 아크릴 형광펜
  'P0000BQD': ['P0000BPZ', 'P00000NB', 'P00000BN'], // (파트너 전용) 아크릴 명찰
  'P0000BPX': ['P00000BA', 'P00000BB', 'P000000X', 'P00000BC'], // (파트너 전용) 아크릴 회전 등신대
  'P0000BPQ': ['P00000CY', 'P00000BN', 'P00000EV'], // (파트너 전용) 아크릴 메지루시 키링
  'P0000BPM': ['P0000BPJ', 'P0000BPK', 'P0000BPL'], // (파트너 전용) 각인 젤펜 볼펜
  'P0000BOW': ['P00000DV', 'P00000RG', 'P00000KI', 'P00000EV', 'P000000Y'], // (파트너 전용) 5T 아크릴 키링
  'P0000BOV': ['P00000BD', 'P00000BN', 'P0000BOX'], // (파트너 전용) 5T 아크릴 스마트톡
  'P0000BLU': ['P00000NB', 'P00000LD', 'P00000KI'], // (파트너 전용) 아크릴 차량용 송풍구 클립
  'P00000ZX': ['P00000NB', 'P00000EV', 'P00000KI'], // (파트너 전용) 아크릴 누들스토퍼
